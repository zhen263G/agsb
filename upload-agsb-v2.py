...
# ====== 全局可配置参数（可直接在此处修改） ======
USER_NAME = "zhengagsb"         # 用户名
UUID = "7981fbb0-aa84-4c1d-8a5a-9630fcbeb0ea"                     # UUID，留空则自动生成
PORT = 49988                   # Vmess端口，留空或0则自动生成
DOMAIN = "kakzheng.kak999.dpdns.org"                   # 域名，留空则自动获取
CF_TOKEN = "eyJhIjoiNjlkMzczOGNjOTQ1ZDZkY2Y5ZThjY2IzOTExYjY2OGIiLCJ0IjoiZjMyNWQzMGMtYmUzOS00YjVkLWFlYzItNGZkODIwOWEzOTEzIiwicyI6Ik56WTNZV1E0T0dVdFpETXlOeTAwWVRrekxUa3dabUl0TnpReU56SmhZVEV5TURrMSJ9"                 # Cloudflare Token，留空则用Quick Tunnel
# =========================================
